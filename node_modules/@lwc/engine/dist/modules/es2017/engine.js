...
function assertAttributeReflectionCapability(vm, attrName) {
    ...
    if (isNodeFromVNode(elm) &&
        ...
        assert.logError(`Invalid attribute access for \`${attrName}\`. Use the corresponding property \`${propName}\` instead.`, elm);
    }
}
        ...
        setAttribute: generateDataDescriptor({
            value(attrName, _value) {
                if (isString(attrName)) {
                    ...
                    const globalAttrName = globalHTMLProperties[propName] && globalHTMLProperties[propName].attribute;
...
export { BaseLightningElement as LightningElement, api$1 as api, buildCustomElementConstructor, createElement, decorate, getComponentConstructor, getComponentDef, isComponentConstructor, isNodeFromTemplate, readonly, register, registerComponent, registerDecorators, registerTemplate, sanitizeAttribute, track, unwrap$1 as unwrap, wire };
/** version: 1.0.0 */

...
(function (global, factory) {
    ...
    */
    ...
    function assertAttributeReflectionCapability(vm, attrName) {
        ...
        var propName = isString(attrName)
    ...
    function getComponentRestrictionsDescriptors(cmp) {
        ...
        return {
            setAttribute: generateDataDescriptor({
                value: function (attrName, _value) {
                    if (isString(attrName)) {
                        var propName = getPropNameFromAttrName(attrName);
                        var globalAttrName = globalHTMLProperties[propName] && globalHTMLProperties[propName].attribute;
                        ...
                        if (attrName === globalAttrName) {
                            var error = globalHTMLProperties[propName].error;
                            if (error) {
    ...
    var CustomElementHook = {
        create: function (vnode) {
            var sel = vnode.sel, elm = vnode.elm;
            if (isUndefined(elm)) {
                // supporting the ability to inject an element via a vnode
                // this is used mostly for caching in compiler and style tags

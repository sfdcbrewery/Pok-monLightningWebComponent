...
`;
    ...
    function getTabbableSegments(host) {
        ...
        const inner = ArraySlice.call(querySelectorAll$1.call(host, TabbableElementsQuery));
        {
    ...
    function PatchedElement(elm) {
        ...
        const { addEventListener: superAddEventListener, removeEventListener: superRemoveEventListener, blur: superBlur, } = elm;
    ...
    function getFilteredSlotAssignedNodes(slot) {
        ...
        const childNodes = ArraySlice.call(childNodesGetter.call(slot));
    ...
    function apply$3() {
        ...
        defineProperty(HTMLBodyElementPrototype, 'querySelector', {
            value() {
                ...
                const filtered = ArrayFind.call(elements, elm => getNodeOwnerKey(elm) === ownerKey || isGlobalPatchingSkipped$1(elm));
                return !isUndefined(filtered) ? filtered : null;
            },
            writable: true,
            enumerable: true,
        ...
        defineProperty(HTMLBodyElementPrototype, 'querySelectorAll', {
            value() {
                const elements = querySelectorAll$1.apply(this, ArraySlice.call(arguments));
                const ownerKey = getNodeOwnerKey(this);
                const filtered = ArrayFilter.call(elements, elm => getNodeOwnerKey(elm) === ownerKey || isGlobalPatchingSkipped$1(elm));
                return createStaticNodeList(filtered);
            },
            writable: true,
            enumerable: true,

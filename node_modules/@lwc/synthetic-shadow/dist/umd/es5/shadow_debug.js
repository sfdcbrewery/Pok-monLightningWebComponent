...
(function (factory) {
    ...
    var _a = Array.prototype, ArrayFilter = _a.filter, ArrayFind = _a.find, ArraySlice = _a.slice, ArraySplice = _a.splice, ArrayIndexOf = _a.indexOf, ArrayPush = _a.push, ArrayMap = _a.map, forEach = _a.forEach, ArrayReduce = _a.reduce, ArrayReverse = _a.reverse;
    ...
    var _b = Element.prototype, addEventListener = _b.addEventListener, removeEventListener = _b.removeEventListener;
    ...
    ***************************************************************************** */
    ...
    function getTabbableSegments(host) {
        ...
        var inner = ArraySlice.call(querySelectorAll$1.call(host, TabbableElementsQuery));
    ...
    function willTriggerFocusInEvent(target) {
        ...
        return (target !== DocumentPrototypeActiveElement.call(doc) && isFocusable(target) // if the element is currently active, it will not fire a focusin event
        );
    }
    function enterMouseDownState(evt) {
        ...
        setTimeout(function () {
            ...
            if (!isNull(currentTarget) && tabIndexGetter.call(currentTarget) === -1) {
    ...
    function PatchedElement(elm) {
        ...
        var superAddEventListener = elm.addEventListener, superRemoveEventListener = elm.removeEventListener, superBlur = elm.blur;
    ...
    function getFilteredSlotAssignedNodes(slot) {
        ...
        var childNodes = ArraySlice.call(childNodesGetter.call(slot));
    ...
    function apply$3() {
        ...
        defineProperty(HTMLBodyElementPrototype, 'querySelector', {
            value: function () {
                ...
                var filtered = ArrayFind.call(elements, function (elm) { return getNodeOwnerKey(elm) === ownerKey || isGlobalPatchingSkipped$1(elm); });
                return !isUndefined(filtered) ? filtered : null;
            },
            writable: true,
            enumerable: true,
        ...
        defineProperty(HTMLBodyElementPrototype, 'querySelectorAll', {
            value: function () {
                var elements = querySelectorAll$1.apply(this, ArraySlice.call(arguments));
                var ownerKey = getNodeOwnerKey(this);
                var filtered = ArrayFilter.call(elements, function (elm) { return getNodeOwnerKey(elm) === ownerKey || isGlobalPatchingSkipped$1(elm); });
                return createStaticNodeList(filtered);
            },
            writable: true,
            enumerable: true,

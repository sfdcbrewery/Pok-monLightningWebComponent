...
function apply() {
    ...
    language_1.defineProperty(Document.prototype, 'querySelector', {
        value() {
            ...
            const filtered = language_1.ArrayFind.call(elements, elm => language_1.isUndefined(node_1.getNodeOwnerKey(elm)) || isGlobalPatchingSkipped(elm));
    ...
    language_1.defineProperty(Document.prototype, 'querySelectorAll', {
        value() {
            const elements = document_1.querySelectorAll.apply(this, language_1.ArraySlice.call(arguments));
            const filtered = language_1.ArrayFilter.call(elements, elm => language_1.isUndefined(node_1.getNodeOwnerKey(elm)) || isGlobalPatchingSkipped(elm));

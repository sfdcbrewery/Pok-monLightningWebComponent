declare const freeze: {
    ...
    <T>(o: T): Readonly<T>;
}, seal: <T>(o: T) => T, keys: (o: {}) => string[], create: {
    (o: object | null): any;
...
}, defineProperty: (o: any, p: string | number | symbol, attributes: PropertyDescriptor & ThisType<any>) => any, getPrototypeOf: (o: any) => any, setPrototypeOf: (o: any, proto: object | null) => any, getOwnPropertyDescriptor: (o: any, p: string | number | symbol) => PropertyDescriptor | undefined, getOwnPropertyNames: (o: any) => string[], defineProperties: (o: any, properties: PropertyDescriptorMap & ThisType<any>) => any, getOwnPropertySymbols: (o: any) => symbol[], hasOwnProperty: (v: string | number | symbol) => boolean, preventExtensions: <T>(o: T) => T, isExtensible: (o: any) => boolean;
...
}, StringToLowerCase: () => string, StringIndexOf: (searchString: string, position?: number | undefined) => number, StringCharCodeAt: (index: number) => number, StringSlice: (start?: number | undefined, end?: number | undefined) => string, StringSplit: {

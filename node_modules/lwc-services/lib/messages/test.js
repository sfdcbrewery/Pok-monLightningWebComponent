...
exports.messages = {
    ...
    flags: {
        ...
        debug: 'runs tests in debug mode (https://jestjs.io/docs/en/troubleshooting)',
        runInBand: 'runs tests serially (slower, but often needed when running on CI systems)',
        passthrough: 'subsequent command line args are passed through (https://jestjs.io/docs/en/cli)'
    },
    logs: {

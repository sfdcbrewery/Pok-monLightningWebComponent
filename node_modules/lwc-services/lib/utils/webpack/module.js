...
const { resolveModulesInDir, resolveLwcNpmModules } = require('@lwc/module-resolver');
const path = require("path");
const lwcConfig_1 = require("../../config/lwcConfig");
let npmmodules;
lwcConfig_1.lwcConfig.localModulesDirs.forEach(dir => {
    const lookupDir = path.resolve(dir);
    npmmodules = Object.assign({}, npmmodules, resolveModulesInDir(lookupDir));
});
npmmodules = Object.assign({}, npmmodules, resolveLwcNpmModules());
const LAYOUT = {
    /**
...
function getConfig(opts) {
    ...
    const moduleConfig = Object.assign({ layout: LAYOUT.STANDARD }, opts.module);
    if (moduleConfig.layout !== LAYOUT.STANDARD &&
        moduleConfig.layout !== LAYOUT.NAMESPACED) {
        throw new TypeError(`module.layout is invalid. Received ${moduleConfig.layout}`);
    }
    return Object.assign({}, opts, { mode: 'dev', module: moduleConfig });
}
